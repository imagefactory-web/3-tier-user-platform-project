...
# ════════════════════════════════════════════════════════════
$S3_BUCKET              = "my-terraform-state-raghava"      # e.g. qa-demo-s3-777
$AWS_REGION             = "ap-south-1"
$CLUSTER_NAME           = "qa-cluster"
$MONITORING_NS          = "monitoring"
$QA_NS                  = "qa"
$GRAFANA_ADMIN_PASSWORD = "admin123"
$NODE_ROLE_NAME         = "eksctl-qa-cluster-nodegroup-qa-wor-NodeInstanceRole-bpKr4TyoHRf6" # eksctl-my-cluster-nodegroup-...-NodeInstanceRole-...
# ════════════════════════════════════════════════════════════
